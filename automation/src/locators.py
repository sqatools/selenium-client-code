...
EVENT_MANAGER_MENU_OPTION = (ID, "j5_TagWatchList_EventManagerMenu_node")
EVENTS_MENU_OPTION = (XPATH, "//td[contains(@id,'dijit_MenuItem')]//a[text()='Events']")
TAG_WATCH_LIST_MENU_OPTION = (XPATH, "//td[contains(@id,'dijit_MenuItem')]//a[text()='Tag Watch List']")
TWL_HEADER = (XPATH, "//span[text()='Tag Watch List']")
TWL_TAG = (XPATH, "//input[contains(@id,'dijit_form_ValidationTextBox_0')]")
TWL_VARIABLE_TYPE_DROPDOWN = (XPATH, "//td[contains(text(), 'Variable Type')]//following-sibling::td[1]//tr")
TWL_DATA_TYPE_DROPDOWN = (XPATH, "//td[contains(text(), 'Data Type')]//following-sibling::td[1]//tr")
TWL_DATASOURCE_DROPDOWN = (XPATH, "//td[contains(text(), 'Datasource')]//following-sibling::td[1]//tr")
TWL_DATASOURCE_TAG_DROPDOWN = (XPATH, "//td[contains(text(), 'Datasource Tag')]//following-sibling::td[1]/div")
TWL_DATASOURCE_TAG_TEXT = (XPATH, "//input[contains(@id, 'dijit_form_FilteringSelect')]")
TWL_UOM = (XPATH, "//input[contains(@id,'dijit_form_ValidationTextBox_1')]")
TWL_MONITORING_STRATEGY = (XPATH, "//td[contains(text(), 'Monitoring')]//following-sibling::td[1]//tr")
TWL_TARGET_POLLING = (XPATH, "//td[contains(text(), 'Target Polling')]//following-sibling::td[1]//tr")
TWL_SITE_DROPDOWN = (XPATH, "//td[contains(text(), 'Site')]//following-sibling::td//tr")
TWL_SECTION_DROPDOWN = (XPATH, "//td[contains(text(), 'Section')]//following-sibling::td//tr")
TWL_AREA_DROPDOWN = (XPATH, "//td[contains(text(), 'Area')]//following-sibling::td//tr")
TWL_UNIT_DROPDOWN = (XPATH, "//td[contains(text(), 'Unit')]//following-sibling::td//tr")
TWL_TARGET_FORM_DROPDOWN = (XPATH, "//td[contains(text(), 'Target Form')]//following-sibling::td//tr")
TWL_DESCRIPTION_TEXTAREA = (XPATH, "//textarea[contains(@name,'newrow_monitoring_variables')]")
